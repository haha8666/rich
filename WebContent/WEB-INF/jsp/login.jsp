                ...
                <div class="p-5">
                  ...
                  <form action="/login" method="post" id="frm" name="frm">
                    <div class="form-group">
                      <input  name="userNm" id="userNm" type="hidden">
                      <input class="form-control form-control-user" name="userId" id="userId" aria-describedby="emailHelp" placeholder="Enter ID...">
                    </div>
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" name="userPwd" id="userPwd" placeholder="Enter Password...">
                    </div>
                    <div class="form-group">
...
<!--                       </div> -->
                    ...
                    <a href="#" onclick="javascript: frm.submit();" class="btn btn-primary btn-user btn-block" onkeyup="enterkey();">
                      Login
                    </a>
                    <input type="hidden" onKeyDown="onKeyDown();">
                    <hr>
                    <a href="https://www.instagram.com/" class="btn btn-google btn-user btn-block">
                  ...
                  <div class="text-center">
                    <a class="small" href="/login/joinPage.co">Create an Account!</a>
                  </div>
                </div>
              </div>
            </div>
